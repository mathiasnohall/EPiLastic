...
namespace EpiLastic.Test.For_EPiServerEventHandler.MovedContent
{
    ...
    public class when_ISearchablePage
    {
        ...
        [Test]
        public void when_move_ISearchablePage_it_should_index()
        {
            _eventHandler.MovedContent(_event);

            A.CallTo(() => _indexClient.IndexAsyncUsingAlias(A<Page>.Ignored, A<string>.Ignored)).MustHaveHappened(Repeated.Exactly.Twice);
