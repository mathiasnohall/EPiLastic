...
namespace EpiLastic.Test.For_IndexingHandler.IndexBlock
{
    ...
    public class when_index_block
    {
        ...
        public when_index_block()
        {
            ...
            var _childblock_being_owned_by_parentpage = A.Fake<SoftLink>();
            ...
            _childblock_being_owned_by_parentpage.LinkMapper = A.Fake<PermanentLinkMapper>();
            #endregion


            // Look over the childblock on page, returns the parentpage ownerlink
            _childblock_being_owned_by_parentpage.OwnerContentLink = _parentPage.ContentLink;
            A.CallTo(() => _contentSoftLinkRepo.Load(_childBlock.ContentLink, true))
                .Returns(new List<SoftLink>
                    {
                        _childblock_being_owned_by_parentpage
                    });
        ...
        {
            var result = _indexingHandler.IndexBlock(_childBlock, "sv");
